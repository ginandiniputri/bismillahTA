    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" method="post" action="<?php echo base_url('admin/driver/doUpdate/').$this->uri->segment(4); ?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" id="form-field-1" name="password" value="" placeholder="Fill Pilot's Password" class="col-xs-10 col-sm-5" />
                            </div>
                        </div>
